    ...
    */
    ...
    APControl = {
		...
		if (nextImage == -1)
		{
            ...
            APControl.setTitle('Klicken um die Diashow zu stoppen');
        ...
        pause : function(){
            ...
            APControl.setTitle('Klicken um die Diashow zu starten');
        ...
        setTitle : function(text){
            if(text)
		autoplayBtn.prop('title', text + ' (Bild wechselt jede ' + options.time/1000 + ' Sekunden)' );
        },
