...
if (isset($_POST["message"]) and isset($_POST["file"]) and isset($_POST["line"]) and isset($_POST["url"]))
{
	...
	$query->execute(array(":message" => $_POST["message"], ":ip" => $_SERVER["REMOTE_ADDR"], ":file" => $_POST["file"], ":line" => $_POST["line"], ":url" => $_POST["url"], ":userAgent" => $_SERVER["HTTP_USER_AGENT"], ":userId" => Constants::$accountManager->getUserId()));
}
else
{
