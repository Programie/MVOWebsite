...
DSN=$(php ${TOOLSPATH}/getconfigvalue.php MYSQL_DSN | sed 's/mysql:\(.*\)/\1/g')
USERNAME="`php ${TOOLSPATH}/getconfigvalue.php MYSQL_USERNAME`"
PASSWORD="`php ${TOOLSPATH}/getconfigvalue.php MYSQL_PASSWORD`"
